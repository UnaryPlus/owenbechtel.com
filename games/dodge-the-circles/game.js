...
function setup() {
    ...
    //Khan Academy sounds
    sounds.die = createAudio("audio/hit-splat.mp3");
    sounds.move = createAudio("audio/battle-swing.mp3");
    sounds.play = createAudio("audio/coin.mp3");
    sounds.yee = createAudio("audio/metal-chime.mp3");
