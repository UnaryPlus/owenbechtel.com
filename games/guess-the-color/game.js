...
function setup() {
  let canvas = createCanvas(400, 400).parent("game")
  canvas.elt.onselectstart = () => false

  redSlider = createSlider(0, 255).parent("game")
  redSlider.size(132)
  redSlider.position(10, 7)

  greenSlider = createSlider(0, 255).parent("game")
  greenSlider.size(132)
  greenSlider.position(10, 27)

  blueSlider = createSlider(0, 255).parent("game")
  blueSlider.size(132)
  blueSlider.position(10, 47)

  button = createButton("guess").parent("game")
  button.position(240, 10)
  button.size(150, 35)
