...
var $author$project$FlappyBird$Bird = F3(
	function (x, y, vy) {
		return {vy: vy, x: x, y: y};
	});
var $author$project$FlappyBird$init = function (highScore) {
	return {
		bird: A3($author$project$FlappyBird$Bird, -300, 0, 0),
		gapY: 0,
		highScore: highScore,
		score: 0
	};
};
var $author$project$FlappyBird$birdHeight = 40;
var $author$project$FlappyBird$gapHeight = 150;
var $author$project$FlappyBird$leftSide = function (screen) {
	return A2($elm$core$Basics$max, screen.left, -400);
};
var $elm$core$Basics$not = _Basics_not;
var $author$project$FlappyBird$obstacleWidth = 85;
...
var $author$project$FlappyBird$randomGapY = function (computer) {
	var height = (computer.screen.height - $author$project$FlappyBird$gapHeight) + 1;
	var digit = $elm$core$Basics$floor(
		A4($evancz$elm_playground$Playground$zigzag, 0, 10, $elm$core$Basics$pi, computer.time));
	return ((digit * height) / 9) - (height / 2);
};
var $elm$core$Basics$min = F2(
	function (x, y) {
		return (_Utils_cmp(x, y) < 0) ? x : y;
	});
var $author$project$FlappyBird$rightSide = function (screen) {
	return A2($elm$core$Basics$min, screen.right, 400);
};
var $author$project$FlappyBird$update = F2(
	function (computer, memory) {
		var vy = _Utils_eq(memory.bird.y, computer.screen.top - ($author$project$FlappyBird$birdHeight / 2)) ? (-0.1) : ((computer.keyboard.up || (computer.keyboard.space || computer.mouse.click)) ? 5 : (memory.bird.vy - 0.3));
		var y = A3($elm$core$Basics$clamp, computer.screen.bottom + ($author$project$FlappyBird$birdHeight / 2), computer.screen.top - ($author$project$FlappyBird$birdHeight / 2), memory.bird.y + vy);
		var offscreen = _Utils_cmp(
			memory.bird.x,
			$author$project$FlappyBird$rightSide(computer.screen)) > 0;
		var score = offscreen ? (memory.score + 1) : memory.score;
		var x = offscreen ? $author$project$FlappyBird$leftSide(computer.screen) : (memory.bird.x + 4);
		var obstacleRight = $author$project$FlappyBird$obstacleWidth / 2;
		var obstacleLeft = 0 - ($author$project$FlappyBird$obstacleWidth / 2);
		var gapY = offscreen ? $author$project$FlappyBird$randomGapY(computer) : memory.gapY;
		var gapTop = gapY + ($author$project$FlappyBird$gapHeight / 2);
		var gapBottom = gapY - ($author$project$FlappyBird$gapHeight / 2);
		var birdTop = y + ($author$project$FlappyBird$birdHeight / 2);
		var birdRight = x + ($author$project$FlappyBird$birdHeight / 2);
		var birdLeft = x - ($author$project$FlappyBird$birdHeight / 2);
		var birdBottom = y - ($author$project$FlappyBird$birdHeight / 2);
		var safe = (_Utils_cmp(birdBottom, gapBottom) > 0) && (_Utils_cmp(birdTop, gapTop) < 0);
		var dead = (_Utils_cmp(birdRight, obstacleLeft) > 0) && ((_Utils_cmp(birdLeft, obstacleRight) < 0) && (!safe));
		return dead ? $author$project$FlappyBird$init(
			A2($elm$core$Basics$max, score, memory.highScore)) : {
			bird: A3($author$project$FlappyBird$Bird, x, y, vy),
			gapY: gapY,
			highScore: memory.highScore,
			score: score
		};
	});
var $author$project$FlappyBird$birdSrc = 'bird.png';
var $author$project$FlappyBird$birdWidth = 56.66;
...
var $evancz$elm_playground$Playground$darkGray = $evancz$elm_playground$Playground$Hex('#babdb6');
...
var $author$project$FlappyBird$view = F2(
	function (computer, memory) {
		return _List_fromArray(
			[
				A3($evancz$elm_playground$Playground$rectangle, $evancz$elm_playground$Playground$darkGreen, $author$project$FlappyBird$obstacleWidth - 10, computer.screen.height),
				A2(
				...
				$evancz$elm_playground$Playground$group(
					_List_fromArray(
						[
							A3($evancz$elm_playground$Playground$rectangle, $evancz$elm_playground$Playground$black, $author$project$FlappyBird$obstacleWidth - 10, $author$project$FlappyBird$gapHeight + 55),
							A3($evancz$elm_playground$Playground$rectangle, $evancz$elm_playground$Playground$darkGreen, $author$project$FlappyBird$obstacleWidth, $author$project$FlappyBird$gapHeight + 50),
							A3($evancz$elm_playground$Playground$rectangle, $evancz$elm_playground$Playground$white, $author$project$FlappyBird$obstacleWidth + 1, $author$project$FlappyBird$gapHeight)
						]))),
				A3(
				$evancz$elm_playground$Playground$move,
				$author$project$FlappyBird$leftSide(computer.screen) + 50,
				...
				A2(
					...
					A2(
						...
						$elm$core$String$fromInt(memory.score)))),
				A3(
				$evancz$elm_playground$Playground$move,
				$author$project$FlappyBird$leftSide(computer.screen) + 50,
				computer.screen.top - 110,
				A2(
					$evancz$elm_playground$Playground$scale,
					3,
					A2(
						$evancz$elm_playground$Playground$words,
						$evancz$elm_playground$Playground$darkGray,
						$elm$core$String$fromInt(memory.highScore)))),
				A3(
				$evancz$elm_playground$Playground$move,
				memory.bird.x,
				memory.bird.y,
				A3($evancz$elm_playground$Playground$image, $author$project$FlappyBird$birdWidth, $author$project$FlappyBird$birdHeight, $author$project$FlappyBird$birdSrc))
			]);
	});
var $author$project$FlappyBird$main = A3(
	$evancz$elm_playground$Playground$game,
	$author$project$FlappyBird$view,
	$author$project$FlappyBird$update,
	$author$project$FlappyBird$init(0));
_Platform_export({'FlappyBird':{'init':$author$project$FlappyBird$main(
