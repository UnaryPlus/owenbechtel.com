...
var $evancz$elm_playground$Playground$gray = $evancz$elm_playground$Playground$Hex('#d3d7cf');
...
var $author$project$Blockade$drawGame = F3(
	function (size, player1, player2) {
		var toSquare = F2(
			function (color, _v0) {
				var x = _v0.a;
				var y = _v0.b;
				return A2(
					...
					((size / 30) * (y - 15)) + (size / 60),
					A2(
						$evancz$elm_playground$Playground$moveX,
						((size / 30) * (x - 15)) + (size / 60),
						A2($evancz$elm_playground$Playground$square, color, (size / 30) + 1)));
			});
		return _Utils_ap(
			_List_fromArray(
				[
					A2($evancz$elm_playground$Playground$square, $evancz$elm_playground$Playground$gray, size)
				]),
			_Utils_ap(
				A2(
					$elm$core$List$map,
					toSquare($evancz$elm_playground$Playground$blue),
					$mgold$elm_nonempty_list$List$Nonempty$toList(player1.points)),
				A2(
					$elm$core$List$map,
					toSquare($evancz$elm_playground$Playground$red),
					$mgold$elm_nonempty_list$List$Nonempty$toList(player2.points))));
	});
...
var $author$project$Blockade$drawWin = F4(
	function (size, score1, score2, result) {
		var _v0 = function () {
			switch (result.$) {
				case 'Win1':
					return _Utils_Tuple2($evancz$elm_playground$Playground$blue, 'Player 1 wins!');
				case 'Win2':
					return _Utils_Tuple2($evancz$elm_playground$Playground$red, 'Player 2 wins!');
				default:
					return _Utils_Tuple2($evancz$elm_playground$Playground$black, 'It\'s a tie.');
			}
		}();
		var color = _v0.a;
		var text = _v0.b;
		return _List_fromArray(
			[
				A2($evancz$elm_playground$Playground$square, color, size),
				A2(
				...
				A2(
					...
					5,
					A2($evancz$elm_playground$Playground$words, $evancz$elm_playground$Playground$white, text))),
				A2(
				...
				A2(
					...
					A2(
						...
						$elm$core$String$fromInt(score1) + (' - ' + $elm$core$String$fromInt(score2))))),
				A2(
				$evancz$elm_playground$Playground$moveDown,
				100,
				A2(
					$evancz$elm_playground$Playground$scale,
					2,
					A2($evancz$elm_playground$Playground$words, $evancz$elm_playground$Playground$white, 'Press space to restart.')))
			]);
	});
...
var $author$project$Blockade$draw = F2(
	function (_v0, memory) {
		var screen = _v0.screen;
		var size = A2($elm$core$Basics$min, screen.width, screen.height);
		var _v1 = memory.scene;
		if (_v1.$ === 'Result') {
			var result = _v1.a;
			return A4($author$project$Blockade$drawWin, size, memory.score1, memory.score2, result);
		} else {
			var player1 = _v1.a.player1;
			var player2 = _v1.a.player2;
			return A3($author$project$Blockade$drawGame, size, player1, player2);
		}
	});
...
var $author$project$Blockade$Game = function (a) {
	return {$: 'Game', a: a};
};
var $author$project$Blockade$Left = {$: 'Left'};
var $author$project$Blockade$Right = {$: 'Right'};
...
var $author$project$Blockade$init = $author$project$Blockade$Game(
	{
		player1: {
			direction: $author$project$Blockade$Right,
			points: $mgold$elm_nonempty_list$List$Nonempty$singleton(
				_Utils_Tuple2(5, 24))
		},
		player2: {
			direction: $author$project$Blockade$Left,
			points: $mgold$elm_nonempty_list$List$Nonempty$singleton(
				_Utils_Tuple2(24, 5))
		},
		time: 0
	});
var $author$project$Blockade$Down = {$: 'Down'};
var $author$project$Blockade$Result = function (a) {
	return {$: 'Result', a: a};
};
var $author$project$Blockade$Tie = {$: 'Tie'};
var $author$project$Blockade$Up = {$: 'Up'};
var $author$project$Blockade$Win1 = {$: 'Win1'};
var $author$project$Blockade$Win2 = {$: 'Win2'};
...
var $author$project$Blockade$move = F2(
	function (direction, _v0) {
		...
		switch (direction.$) {
			case 'Up':
				return _Utils_Tuple2(
					x,
					A2($elm$core$Basics$modBy, 30, y + 1));
			case 'Down':
				return _Utils_Tuple2(
					x,
					A2($elm$core$Basics$modBy, 30, y - 1));
			case 'Left':
				return _Utils_Tuple2(
					A2($elm$core$Basics$modBy, 30, x - 1),
					y);
			default:
				return _Utils_Tuple2(
					A2($elm$core$Basics$modBy, 30, x + 1),
...
var $author$project$Blockade$updateGame = F6(
	function (keyboard, score1, score2, player1, player2, time) {
		var keyDown = function (k) {
			return A2($elm$core$Set$member, k, keyboard.keys) || A2(
				$elm$core$Set$member,
				$elm$core$String$toUpper(k),
				keyboard.keys);
		};
		var direction2 = (keyboard.up && (!_Utils_eq(player2.direction, $author$project$Blockade$Down))) ? $author$project$Blockade$Up : ((keyboard.down && (!_Utils_eq(player2.direction, $author$project$Blockade$Up))) ? $author$project$Blockade$Down : ((keyboard.left && (!_Utils_eq(player2.direction, $author$project$Blockade$Right))) ? $author$project$Blockade$Left : ((keyboard.right && (!_Utils_eq(player2.direction, $author$project$Blockade$Left))) ? $author$project$Blockade$Right : player2.direction)));
		var point2 = A2(
			$author$project$Blockade$move,
			direction2,
			$mgold$elm_nonempty_list$List$Nonempty$head(player2.points));
		var points2 = (!A2($elm$core$Basics$modBy, 6, time)) ? A2($mgold$elm_nonempty_list$List$Nonempty$cons, point2, player2.points) : player2.points;
		var newPlayer2 = _Utils_update(
			player2,
			{direction: direction2, points: points2});
		var direction1 = (keyDown('w') && (!_Utils_eq(player1.direction, $author$project$Blockade$Down))) ? $author$project$Blockade$Up : ((keyDown('s') && (!_Utils_eq(player1.direction, $author$project$Blockade$Up))) ? $author$project$Blockade$Down : ((keyDown('a') && (!_Utils_eq(player1.direction, $author$project$Blockade$Right))) ? $author$project$Blockade$Left : ((keyDown('d') && (!_Utils_eq(player1.direction, $author$project$Blockade$Left))) ? $author$project$Blockade$Right : player1.direction)));
		var point1 = A2(
			$author$project$Blockade$move,
			direction1,
			$mgold$elm_nonempty_list$List$Nonempty$head(player1.points));
		var points1 = (!A2($elm$core$Basics$modBy, 6, time)) ? A2($mgold$elm_nonempty_list$List$Nonempty$cons, point1, player1.points) : player1.points;
		var newPlayer1 = _Utils_update(
			player1,
			{direction: direction1, points: points1});
		var dead2 = A2($mgold$elm_nonempty_list$List$Nonempty$member, point2, points1) || A2($mgold$elm_nonempty_list$List$Nonempty$member, point2, player2.points);
		var dead1 = A2($mgold$elm_nonempty_list$List$Nonempty$member, point1, player1.points) || A2($mgold$elm_nonempty_list$List$Nonempty$member, point1, points2);
		var scene = function () {
			var _v4 = _Utils_Tuple2(dead1, dead2);
			if (_v4.a) {
				if (_v4.b) {
					return $author$project$Blockade$Result($author$project$Blockade$Tie);
				} else {
					return $author$project$Blockade$Result($author$project$Blockade$Win2);
				}
			} else {
				if (_v4.b) {
					return $author$project$Blockade$Result($author$project$Blockade$Win1);
				} else {
					return $author$project$Blockade$Game(
						{player1: newPlayer1, player2: newPlayer2, time: time + 1});
				}
			}
		}();
		var newScore1 = function () {
			if ((scene.$ === 'Result') && (scene.a.$ === 'Win1')) {
				var _v3 = scene.a;
				return score1 + 1;
			} else {
				return score1;
		...
		var newScore2 = function () {
			if ((scene.$ === 'Result') && (scene.a.$ === 'Win2')) {
				var _v1 = scene.a;
				return score2 + 1;
			} else {
				return score2;
		...
		return {scene: scene, score1: newScore1, score2: newScore2};
	});
var $author$project$Blockade$update = F2(
	function (_v0, memory) {
		var keyboard = _v0.keyboard;
		var _v1 = memory.scene;
		if (_v1.$ === 'Result') {
			var result = _v1.a;
			return keyboard.space ? _Utils_update(
				memory,
				{scene: $author$project$Blockade$init}) : memory;
		} else {
			var player1 = _v1.a.player1;
			var player2 = _v1.a.player2;
			var time = _v1.a.time;
			return A6($author$project$Blockade$updateGame, keyboard, memory.score1, memory.score2, player1, player2, time);
		}
	});
var $author$project$Blockade$main = A3(
	$evancz$elm_playground$Playground$game,
	$author$project$Blockade$draw,
	$author$project$Blockade$update,
	{scene: $author$project$Blockade$init, score1: 0, score2: 0});
_Platform_export({'Blockade':{'init':$author$project$Blockade$main(
