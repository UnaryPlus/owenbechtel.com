...
[Update: Shortly after writing this article, I realized that the last sentence above is false, and that $$n=2$$ is a special case. See [my most recent article](../groups-with-roots-of-unity/).]

[*Update: This is false if $$K$$ has characteristic 2. In that case, everything is already its own negative, so we just get the group algebra, which is $$\lvert G\rvert$$-dimensional.]
